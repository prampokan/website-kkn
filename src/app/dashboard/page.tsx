            ...
            <div className="w-[70rem]">
                ...
                <div className="mt-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 mt-8">
                        <Link href={'/'} className="bg-red-100 h-20 w-full sm:w-[23%] xl:w-52 rounded-xl shadow-lg border border-zinc-400 flex items-center justify-center gap-2 cursor-pointer hover:shadow-2xl hover:text-black transition-all">
