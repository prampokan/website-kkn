            ...
            <div className="w-[70rem]">
                ...
                <div className="mt-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 mt-8">
                        ...
                        <Link href={'/dashboard/kegiatan/kesehatan'} className="bg-red-100 h-20 w-full sm:w-[23%] xl:w-52 rounded-xl shadow-lg border border-zinc-400 flex items-center justify-center gap-2 cursor-pointer hover:shadow-2xl hover:text-black transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-red-500">
                        ...
                        <Link href={'/dashboard/kegiatan/kebudayaan'} className="bg-red-100 h-20 w-full sm:w-[23%] xl:w-52 rounded-xl shadow-lg border border-zinc-400 flex items-center justify-center gap-2 cursor-pointer hover:shadow-2xl hover:text-black transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-red-500">
                        ...
                        <Link href={'/dashboard/kegiatan/umkm'} className="bg-red-100 h-20 w-full sm:w-[23%] xl:w-52 rounded-xl shadow-lg border border-zinc-400 flex items-center justify-center gap-2 cursor-pointer hover:shadow-2xl hover:text-black transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-red-500">
